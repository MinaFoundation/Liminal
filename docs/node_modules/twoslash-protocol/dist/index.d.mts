import { Range, Position, NodeStartLength, NodeWithoutPosition, TwoslashNode } from 'twoslash-protocol/types';
export { CompletionEntry, ErrorLevel, NodeBase, NodeCompletion, NodeError, NodeErrorWithoutPosition, NodeHighlight, NodeHover, NodeQuery, NodeTag, TwoslashGenericFunction, TwoslashGenericResult } from 'twoslash-protocol/types';
