...
function createTwoslasher(createOptions = {}) {
  ...
  function getVueLanguage(compilerOptions, vueCompilerOptions) {
    ...
    function getLanguage() {
      const vueLanguagePlugin = languageCore.createVueLanguagePlugin(ts__default, (id) => id, () => "", () => true, twoslash.defaultCompilerOptions, languageCore.resolveVueCompilerOptions(vueCompilerOptions));
